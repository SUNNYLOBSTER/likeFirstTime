...
<body data-editor="ClassicEditor" data-collaboration="false" data-revision-history="false">
	<div id="container">
		...
		<form action="./insertNewChart.do" method="post">
			...
			진료과목 : <select id="codeL" onchange="codeLChange()" name="codeL">
					...
					<select id="codeS" onchange="selectedSCode(this.value);" name="codeS">
						<option>--질환--</option>
					</select>
					<input type="hidden" id="medi_snameInput">
			<br>
			
			반려동물 : <select id="petName" name="petName" onclick="selectedPet(this.value);">
						<option>--선택--</option>
