...
SELECT p.PET_NAME , m.MEDI_TITLE , m2.MEDI_NAME , m3.MEDI_NAME 
	FROM PETSINFO p 
	LEFT JOIN MEDICHART m ON p.PET_SEQ = m.MPET_SEQ
	JOIN MEDICODE m2 ON m2.MEDI_CODE = m.MEDI_L
	LEFT JOIN MEDICODE m3 ON m2.MEDI_CODE = m.MEDI_S 
